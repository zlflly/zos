...
(() => {
  ...
  // module/tests/testutils-browser.js
  ...
  describe("HTMLProcessor.applyToElement.separator.node", () => {
    it("should clone separator element deeply", () => {
      ...
      const expected = '<div class="applied">\u4ECA\u65E5\u306F<span style="white-space: normal;">\u200B</span>\u826F\u3044<span style="white-space: normal;">\u200B</span>\u5929\u6C17\u3067\u3059</div>';
  ...
  describe("HTMLProcessingParser.applyToElement", () => {
    const checkEqual = (model2, inputHTML, expectedHTML) => {
      ...
      const parser2 = new HTMLProcessingParser(model2);
      parser2.applyToElement(inputDocument);
  ...
  describe("HTMLProcessingParser.translateHTMLString", () => {
    ...
    const checkEqual = (model2, inputHTML, expectedHTML) => {
      const parser2 = new HTMLProcessingParser(model2);
      const result = parser2.translateHTMLString(inputHTML);
  ...
  describe("Parser.parse", () => {
    ...
    it("should separate if a strong feature item supports.", () => {
      ...
      const parser2 = new Parser(model2);
      const result = parser2.parse(TEST_SENTENCE);
